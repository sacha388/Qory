...
export function buildStructuredAuditPrompt(
  ...
  return [
    ...
    'Format JSON attendu:',
    '{',
    '  "answer_short": "réponse courte qui répond à la question utilisateur",',
    '  "mentioned": true|false,',
    '  "position": number|null,',
    '  "top_entities": [{ "name": string, "rank": number|null, "role": "target|competitor|other" }],',
    '  "competitors": ["nom1", "nom2", "nom3", "nom4", "nom5"],',
    '  "excerpt": "court extrait utile de la réponse",',
    '  "citation": string',
    '}',
    'Contraintes obligatoires:',
    '- Réponds d’abord à la question utilisateur, puis structure honnêtement les marques qui ressortent.',
    ...
    '- position: rang de l’entreprise cible dans ta réponse si mentioned=true, sinon null.',
    '- top_entities: liste ordonnée des marques, entreprises ou sites précis qui répondent le mieux à la question. Inclus l’entreprise cible avec role="target" si elle ressort, les autres avec role="competitor" ou "other".',
    '- competitors: noms précis d’entreprises, marques, boutiques, logiciels, plateformes ou sites concurrents cités dans top_entities. Pas de catégories génériques, pas de fragments de phrase, pas de doublons, maximum 5.',
    '- Pour une question de comparaison, d’alternatives, de meilleures options, d’avis ou de fiabilité, competitors ne doit être [] que si aucun nom précis ne ressort vraiment après recherche.',
    '- N’utilise jamais de catégories génériques dans competitors (ex: "écoles locales", "plateformes", "annuaires").',
    '- answer_short et excerpt doivent mentionner les principaux noms ressortis quand la question appelle des concurrents.',
    '- citation: maximum 180 caractères. Résume très brièvement le signal principal ou indique une source/indice utile.',
