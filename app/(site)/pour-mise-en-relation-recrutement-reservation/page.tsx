...
const pageData = getReadyUseCaseSectorPageBySlug('plateformes-mise-en-relation-recrutement-reservation');
...
export default function MatchingRecruitmentReservationUseCasePage() {
