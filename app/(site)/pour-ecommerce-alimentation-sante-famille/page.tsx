...
const pageData = getReadyUseCaseSectorPageBySlug('ecommerce-alimentation-sante-famille');
...
export default function EcommerceAlimentationSanteFamilleUseCasePage() {
