...
const pageData = getReadyUseCaseSectorPageBySlug('ecommerce-luxe-animalerie-b2b-specialise');
...
export default function EcommerceLuxeAnimalerieB2BSpecialiseUseCasePage() {
