...
const pageData = getReadyUseCaseSectorPageBySlug('comparateurs-forums-avis-agregateurs');
...
export default function ComparatorsForumsReviewsAggregatorsUseCasePage() {
