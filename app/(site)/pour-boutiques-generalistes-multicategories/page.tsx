...
const pageData = getReadyUseCaseSectorPageBySlug('boutiques-generalistes-multicategories');
...
export default function BoutiquesGeneralistesMulticategoriesUseCasePage() {
