...
const pageData = getReadyUseCaseSectorPageBySlug('services-publics-associations-fondations');
...
export default function PublicServicesAssociationsFoundationsUseCasePage() {
