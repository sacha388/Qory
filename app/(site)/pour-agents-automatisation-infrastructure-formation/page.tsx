...
const pageData = getReadyUseCaseSectorPageBySlug('agents-automatisation-infrastructure-formation');
...
export default function AgentsAutomationInfrastructureTrainingUseCasePage() {
