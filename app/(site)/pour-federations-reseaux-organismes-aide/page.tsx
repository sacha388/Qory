...
const pageData = getReadyUseCaseSectorPageBySlug('federations-reseaux-organismes-aide');
...
export default function FederationsNetworksSupportOrganizationsUseCasePage() {
